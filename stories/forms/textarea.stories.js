...
export const Textarea_with_placeholder = () => (
  <div className='m-s'>
    <div className='form-group'>
      ...
      <textarea className='form-control' name='textarea' id='textarea' rows='5' placeholder='Enter description'/>
    </div>
  </div>
)
...
export const Textarea_disabled = () => (
  <div className='m-s'>
    <div className='form-group'>
      ...
      <textarea className='form-control' name='textarea' id='textarea' rows='5' disabled />
    </div>
  </div>
)
